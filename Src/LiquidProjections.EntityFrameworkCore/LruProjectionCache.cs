...
using LiquidProjections.EntityFrameworkCore.App_Packages.FluidCaching.Sources;

namespace LiquidProjections.EntityFrameworkCore
{
    /// <inheritdoc />
    /// <summary>
    /// An implementation of the <see cref="T:LiquidProjections.EntityFrameworkCore.IProjectionCache`2" /> based on https://www.nuget.org/packages/FluidCaching.Sources/
    /// </summary>
