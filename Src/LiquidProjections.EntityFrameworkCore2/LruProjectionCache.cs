...
using LiquidProjections.EFCore.App_Packages.FluidCaching.Sources;

namespace LiquidProjections.EFCore
{
    /// <inheritdoc />
    /// <summary>
    /// An implementation of the <see cref="T:LiquidProjections.EFCore.IProjectionCache`2" /> based on https://www.nuget.org/packages/FluidCaching.Sources/
    /// </summary>
